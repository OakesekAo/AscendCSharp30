...
public static class CustomerEndpoints
{
    public static void MapCustomerEndpoints(this WebApplication app)
    {
        ...
        group.MapGet("/paginated", GetPaginated)
            .WithName("GetCustomersPaginated")
            .WithOpenApi();
    ...
    private static async Task<IResult> GetPaginated(CustomerService service, int page = 1, int pageSize = 10)
    {
        ...
        try
        {
            var result = await service.GetPaginatedAsync(page, pageSize);
